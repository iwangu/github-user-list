Simple but all-encompassing react,redux and typescript SPA.
File structure follows the redux "ducks" pattern.
The app fetches users from the github API and displays them in a list.
Each user item is clickable and take you to a user profile.

The app is responsive.

**Here is the live version:**

* https://frejp.github.io/github-user-list/
